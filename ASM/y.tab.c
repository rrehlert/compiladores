...
{
       0,    78,    78,    81,    82,    83,    86,    87,    90,    93,
      94,    95,    98,   101,   102,   105,   106,   107,   110,   111,
     114,   115,   116,   120,   121,   122,   123,   124,   125,   126,
     127,   128,   131,   134,   135,   138,   139,   140,   143,   144,
     148,   149,   153,   154,   158,   159,   162,   163,   164,   165,
...
static const char *const yytname[] =
{
  ...
  "TOKEN_ERROR", "'&'", "'|'", "'~'", "'<'", "'>'", "'+'", "'-'", "'.'",
  "'/'", "';'", "'('", "')'", "'['", "']'", "'{'", "'}'", "$accept",
  "program", "list", "dec", "func", "type", "array", "init", "literal",
